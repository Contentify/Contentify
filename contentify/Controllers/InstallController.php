    ...
    public function index($step = -1, $errors = null) 
    {
        ...
        switch ($step) {
            ...
            case 4:
                ...
                File::put(storage_path('app/database.ini'), 
            ...
            case 3:
                ...
                $content    = '<p>Fill in the database connection settings.</p>'.
                              '<div class="warning">'.Form::errors($errors).'</div>'.
                              Form::open(['url' => 'install?step='.($step + 1)]).
                              Form::smartText('host', 'Host', 'localhost').
                              Form::smartText('database', 'Database', 'contentify').
                              Form::smartText('username', 'Username', 'root').
