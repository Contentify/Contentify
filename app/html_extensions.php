...
HTML::macro('imageLink', 
     ...
     * @return string
     */
    function ($image, $title, $url, $showTitle = false, $attributes = array())
    {
...
HTML::macro('sortSwitcher',
     ...
     * @return string
     */
    function ($sortby, $order = null, $search = null)
    {
        if ($order == 'asc') {
            $order  = 'desc';
