...
namespace Illuminate\Support\Facades {
    ...
    class Cache {
        ...
        {
            \Illuminate\Cache\Repository::put($key, $value, $seconds);
        }
         ...
         * @static
         */
        public static function putMany($values, $seconds)
        {
            \Illuminate\Cache\Repository::putMany($values, $seconds);
        }
        ...
        {
            return \Illuminate\Cache\Repository::add($key, $value, $seconds);
        }
        ...
        {
            return \Illuminate\Cache\Repository::remember($key, $seconds, $callback);
        }
        ...
        {
            \Illuminate\Cache\Repository::setDefaultCacheTime($seconds);
        }
