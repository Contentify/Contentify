...
<head>
    ...
    <style>
        ...
        body { margin: 0px; font-family: Verdana; font-size: 12px; color: silver; background-color: white }
        ...
        .message-box h1 { margin: 0px; font-family: 'Lato'; font-size: 20px; font-weight: normal; color: #ff6100; text-transform: uppercase }
        .message-box p { margin: 20px 0px 0px 0px; font-family: 'Open Sans'; font-size: 14px; color: #666; }
        .message-box p a { color: #999; text-decoration: none }
        .message-box hr { margin: 15px 0px; border: none; border-bottom: 1px dashed #ccc }
